...
36083(__unused_webpack_module, __unused_webpack___webpack_exports__, __webpack_require__) {
 ...
 */ /**
 * UI theme.
 */ var TelemetryTheme = /*#__PURE__*/ (/* unused pure expression or super */ null && (function(TelemetryTheme) {
 ...
 */ var TelemetryFilterUpdateIntervalMode = /*#__PURE__*/ (/* unused pure expression or super */ null && (function(TelemetryFilterUpdateIntervalMode) {
...
var node_modules_classnames = __webpack_require__(52996);
// EXTERNAL MODULE: ./Extension/src/pages/common/components/Editor/savingFSM.ts
var savingFSM = __webpack_require__(12968);
// EXTERNAL MODULE: ./Extension/src/common/translators/translator.ts
var translators_translator = __webpack_require__(78466);
// EXTERNAL MODULE: ./Extension/src/pages/common/components/ui/Icon.tsx
var ui_Icon = __webpack_require__(82006);
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0,jsx_runtime.jsx)("button", {
                ...
                onClick: onClick,
                title: translators_translator/* .translator.getMessage */.N.getMessage('options_editor_save'),
                disabled: !contentChanged,
                "aria-keyshortcuts": user_agent/* .UserAgent.isMacOs */.B.isMacOs ? 'Meta+S' : 'Ctrl+S',
                children: translators_translator/* .translator.getMessage */.N.getMessage('options_editor_save')
            })
        ]
    });
};
...
/* import */ var date_fns__rspack_import_4 = __webpack_require__(72664);
...
var sortBy = __webpack_require__(99067);
...
var custom_filter_utils = __webpack_require__(20862);
;// CONCATENATED MODULE: ./Extension/src/common/common-filter-utils.ts
/**
 * Copyright (c) 2015-2025 Adguard Software Ltd.
 *
 * @file
 ...
 */ class CommonFilterUtils {
     ...
     */ static isCommonFilter(filterId) {
        return !custom_filter_utils/* .CustomFilterUtils.isCustomFilter */.D.isCustomFilter(filterId) && filterId !== constants/* .AntiBannerFiltersId.UserFilterId */.j8.UserFilterId && filterId !== constants/* .AntiBannerFiltersId.AllowlistFilterId */.j8.AllowlistFilterId;
    }
    /**
...
;// CONCATENATED MODULE: ./Extension/src/pages/options/components/Filters/helpers.ts
/**
 * Copyright (c) 2015-2025 Adguard Software Ltd.
 *
 * @file
...
var RootStore = __webpack_require__(1278);
// EXTERNAL MODULE: ./node_modules/.pnpm/classnames@2.3.2/node_modules/classnames/index.js
var classnames = __webpack_require__(52996);
var classnames_default = /*#__PURE__*/__webpack_require__.n(classnames);
// EXTERNAL MODULE: ./Extension/src/common/constants.ts
...
1278(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var helpers = __webpack_require__(6328);
...
;// CONCATENATED MODULE: ./Extension/src/pages/options/stores/SettingsStore/SettingsStore-mv3.ts
/**
 * Copyright (c) 2015-2025 Adguard Software Ltd.
 *
 * @file
 ...
 * You should have received a copy of the GNU General Public License
 * along with AdGuard Browser Extension. If not, see <http://www.gnu.org/licenses/>.
 */ function SettingsStore_mv3_define_property(obj, key, value) {
    if (key in obj) {
        Object.defineProperty(obj, key, {
            value: value,
            enumerable: true,
...
function SettingsStore_mv3_ts_decorate(decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for(var i = decorators.length - 1; i >= 0; i--)if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    return c > 3 && r && Object.defineProperty(target, key, r), r;
}
function SettingsStore_mv3_ts_metadata(k, v) {
    if (typeof Reflect === "object" && typeof Reflect.metadata === "function") return Reflect.metadata(k, v);
}
...
class SettingsStore extends SettingsStoreCommon {
     ...
     */ applyRuntimeInfo(runtimeInfo) {
        const { isExtensionUpdateAvailable, isExtensionReloadedOnUpdate, isSuccessfulExtensionUpdate } = runtimeInfo;
        ...
        if (isExtensionReloadedOnUpdate) {
            const notification = isSuccessfulExtensionUpdate ? {
                type: types/* .NotificationType.Success */._.Success,
                text: translator/* .translator.getMessage */.N.getMessage('update_success_text')
            } : {
                type: types/* .NotificationType.Error */._.Error,
                text: translator/* .translator.getMessage */.N.getMessage('update_failed_text'),
                button: {
                    title: translator/* .translator.getMessage */.N.getMessage('update_failed_try_again_btn'),
     ...
     */ async getRulesLimitsCounters() {
        const rulesLimits = await fetchDataWithRetry(messenger/* .messenger.getRulesLimitsCounters.bind */.ee.getRulesLimitsCounters.bind(messenger/* .messenger */.ee));
    ...
    async checkUpdates() {
        const start = Date.now();
        try {
            await messenger/* .messenger.checkUpdates */.ee.checkUpdates();
        } catch (error) {
            logger/* .logger.debug */.v.debug('[ext.SettingsStore.checkUpdates]: failed to check updates on options page: ', error);
        }
    ...
    async updateExtensionMV3() {
        const start = Date.now();
        try {
            await messenger/* .messenger.updateExtension */.ee.updateExtension({
                from: forward/* .ForwardFrom.Options */.S9.Options
            });
        } catch (error) {
            logger/* .logger.debug */.v.debug('[ext.SettingsStore.updateExtensionMV3]: failed to update extension on options page: ', error);
        }
    ...
    setIsExtensionCheckingUpdateOrUpdating(value) {
     ...
     */ SettingsStore_mv3_define_property(this, "isExtensionUpdateAvailable", false), /**
     * Current rule limits and counters for DNR.
     */ SettingsStore_mv3_define_property(this, "rulesLimits", DEFAULT_RULES_LIMITS), /**
     * Whether the extension update is checking or is updating now.
     */ SettingsStore_mv3_define_property(this, "isExtensionCheckingUpdateOrUpdating", false);
        this.checkUpdates = this.checkUpdates.bind(this);
        (0,mobx_esm/* .makeObservable */.Gn)(this);
    }
}
SettingsStore_mv3_ts_decorate([
    mobx_esm/* .observable */.sH
], SettingsStore.prototype, "isExtensionUpdateAvailable", void 0);
SettingsStore_mv3_ts_decorate([
    mobx_esm/* .observable */.sH,
    SettingsStore_mv3_ts_metadata("design:type", typeof IRulesLimits === "undefined" ? Object : IRulesLimits)
...
SettingsStore_mv3_ts_decorate([
    mobx_esm/* .override */.$Z,
    SettingsStore_mv3_ts_metadata("design:type", Function),
    SettingsStore_mv3_ts_metadata("design:paramtypes", [
        Boolean
    ]),
    SettingsStore_mv3_ts_metadata("design:returntype", Promise)
...
SettingsStore_mv3_ts_decorate([
    ...
    SettingsStore_mv3_ts_metadata("design:returntype", void 0)
], SettingsStore.prototype, "applyRuntimeInfo", null);
SettingsStore_mv3_ts_decorate([
    mobx_esm/* .override */.$Z,
    SettingsStore_mv3_ts_metadata("design:type", Function),
    SettingsStore_mv3_ts_metadata("design:paramtypes", [
...
SettingsStore_mv3_ts_decorate([
    ...
    SettingsStore_mv3_ts_metadata("design:paramtypes", []),
    SettingsStore_mv3_ts_metadata("design:returntype", Promise)
], SettingsStore.prototype, "checkUpdates", null);
SettingsStore_mv3_ts_decorate([
    mobx_esm/* .action */.XI,
    SettingsStore_mv3_ts_metadata("design:type", Function),
    SettingsStore_mv3_ts_metadata("design:paramtypes", [
...
/* import */ var messenger__rspack_import_0 = __webpack_require__(2036);
...
class Messenger extends _messenger_common__rspack_import_1/* .MessengerCommon */.H {
     ...
     */ _define_property(this, "checkUpdates", async ()=>{
            return this.sendMessage(_common_messages__rspack_import_0/* .MessageType.CheckExtensionUpdateMv3 */.Go.CheckExtensionUpdateMv3);
        }), /**
     * Sends a message to the background page to update extension.
     */ _define_property(this, "updateExtension", async ({ from })=>{
            return this.sendMessage(_common_messages__rspack_import_0/* .MessageType.UpdateExtensionMv3 */.Go.UpdateExtensionMv3, {
                from
            });
        }), /**
     ...
     */ _define_property(this, "getExtensionStatusForPopup", async ()=>{
            return this.sendMessage(_common_messages__rspack_import_0/* .MessageType.GetExtensionStatusForPopupMV3 */.Go.GetExtensionStatusForPopupMV3);
        });
    }
}
...
69666(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  F: () => (addLeadingZeros)
});
...
74499(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  q: () => (getDefaultOptions)
});
let defaultOptions = {};
...
27643(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  _: () => (formatters)
});
/* import */ var _getDayOfYear_js__rspack_import_6 = __webpack_require__(50797);
/* import */ var _getISOWeek_js__rspack_import_5 = __webpack_require__(50418);
/* import */ var _getISOWeekYear_js__rspack_import_3 = __webpack_require__(35119);
/* import */ var _getWeek_js__rspack_import_4 = __webpack_require__(12727);
/* import */ var _getWeekYear_js__rspack_import_1 = __webpack_require__(54594);
/* import */ var _addLeadingZeros_js__rspack_import_2 = __webpack_require__(69666);
/* import */ var _lightFormatters_js__rspack_import_0 = __webpack_require__(33997);
...
const formatters = {
  ...
  y: function (date, token, localize) {
    ...
    return _lightFormatters_js__rspack_import_0/* .lightFormatters.y */.C.y(date, token);
  },

  // Local week-numbering year
  Y: function (date, token, localize, options) {
    const signedWeekYear = (0,_getWeekYear_js__rspack_import_1/* .getWeekYear */.h)(date, options);
    // Returns 1 for 1 BC (which is year 0 in JavaScript)
    ...
    if (token === "YY") {
      ...
      return (0,_addLeadingZeros_js__rspack_import_2/* .addLeadingZeros */.F)(twoDigitYear, 2);
    }
    ...
    // Padding
    return (0,_addLeadingZeros_js__rspack_import_2/* .addLeadingZeros */.F)(weekYear, token.length);
  },

  // ISO week-numbering year
  R: function (date, token) {
    const isoWeekYear = (0,_getISOWeekYear_js__rspack_import_3/* .getISOWeekYear */.p)(date);

    // Padding
    return (0,_addLeadingZeros_js__rspack_import_2/* .addLeadingZeros */.F)(isoWeekYear, token.length);
  },
  ...
  u: function (date, token) {
    ...
    return (0,_addLeadingZeros_js__rspack_import_2/* .addLeadingZeros */.F)(year, token.length);
  },
  ...
  Q: function (date, token, localize) {
    ...
    switch (token) {
      ...
      // 01, 02, 03, 04
      case "QQ":
        return (0,_addLeadingZeros_js__rspack_import_2/* .addLeadingZeros */.F)(quarter, 2);
      // 1st, 2nd, 3rd, 4th
      case "Qo":
  ...
  M: function (date, token, localize) {
    ...
    switch (token) {
      case "M":
      case "MM":
        return _lightFormatters_js__rspack_import_0/* .lightFormatters.M */.C.M(date, token);
      // 1st, 2nd, ..., 12th
      case "Mo":
  ...
  L: function (date, token, localize) {
    ...
    switch (token) {
      ...
      // 01, 02, ..., 12
      case "LL":
        return (0,_addLeadingZeros_js__rspack_import_2/* .addLeadingZeros */.F)(month + 1, 2);
      // 1st, 2nd, ..., 12th
      case "Lo":
        return localize.ordinalNumber(month + 1, { unit: "month" });
      // Jan, Feb, ..., Dec
  ...
  w: function (date, token, localize, options) {
    const week = (0,_getWeek_js__rspack_import_4/* .getWeek */.N)(date, options);

    if (token === "wo") {
      return localize.ordinalNumber(week, { unit: "week" });
    }

    return (0,_addLeadingZeros_js__rspack_import_2/* .addLeadingZeros */.F)(week, token.length);
  },

  // ISO week of year
  I: function (date, token, localize) {
    const isoWeek = (0,_getISOWeek_js__rspack_import_5/* .getISOWeek */.s)(date);

    if (token === "Io") {
      return localize.ordinalNumber(isoWeek, { unit: "week" });
    }

    return (0,_addLeadingZeros_js__rspack_import_2/* .addLeadingZeros */.F)(isoWeek, token.length);
  },
  ...
  d: function (date, token, localize) {
    ...
    return _lightFormatters_js__rspack_import_0/* .lightFormatters.d */.C.d(date, token);
  },

  // Day of year
  D: function (date, token, localize) {
    const dayOfYear = (0,_getDayOfYear_js__rspack_import_6/* .getDayOfYear */.F)(date);

    if (token === "Do") {
      return localize.ordinalNumber(dayOfYear, { unit: "dayOfYear" });
    }

    return (0,_addLeadingZeros_js__rspack_import_2/* .addLeadingZeros */.F)(dayOfYear, token.length);
  },
  ...
  e: function (date, token, localize, options) {
    ...
    switch (token) {
      ...
      case "ee":
        return (0,_addLeadingZeros_js__rspack_import_2/* .addLeadingZeros */.F)(localDayOfWeek, 2);
      // 1st, 2nd, ..., 7th
      case "eo":
  ...
  c: function (date, token, localize, options) {
    ...
    switch (token) {
      ...
      // Padded numerical value
      case "cc":
        return (0,_addLeadingZeros_js__rspack_import_2/* .addLeadingZeros */.F)(localDayOfWeek, token.length);
      // 1st, 2nd, ..., 7th
      case "co":
        return localize.ordinalNumber(localDayOfWeek, { unit: "day" });
      case "ccc":
  ...
  i: function (date, token, localize) {
    ...
    switch (token) {
      ...
      // 02
      case "ii":
        return (0,_addLeadingZeros_js__rspack_import_2/* .addLeadingZeros */.F)(isoDayOfWeek, token.length);
      // 2nd
      case "io":
  ...
  h: function (date, token, localize) {
    ...
    return _lightFormatters_js__rspack_import_0/* .lightFormatters.h */.C.h(date, token);
  },
  ...
  K: function (date, token, localize) {
    ...
    return (0,_addLeadingZeros_js__rspack_import_2/* .addLeadingZeros */.F)(hours, token.length);
  },
  ...
  s: function (date, token, localize) {
    ...
    return _lightFormatters_js__rspack_import_0/* .lightFormatters.s */.C.s(date, token);
  },
  ...
  t: function (date, token, _localize) {
    ...
    return (0,_addLeadingZeros_js__rspack_import_2/* .addLeadingZeros */.F)(timestamp, token.length);
  },

  // Milliseconds timestamp
  T: function (date, token, _localize) {
    return (0,_addLeadingZeros_js__rspack_import_2/* .addLeadingZeros */.F)(+date, token.length);
  },
};
...
function formatTimezoneShort(offset, delimiter = "") {
  ...
  return sign + String(hours) + delimiter + (0,_addLeadingZeros_js__rspack_import_2/* .addLeadingZeros */.F)(minutes, 2);
}

function formatTimezoneWithOptionalMinutes(offset, delimiter) {
  if (offset % 60 === 0) {
    const sign = offset > 0 ? "-" : "+";
    return sign + (0,_addLeadingZeros_js__rspack_import_2/* .addLeadingZeros */.F)(Math.abs(offset) / 60, 2);
  }
...
function formatTimezone(offset, delimiter = "") {
  const sign = offset > 0 ? "-" : "+";
  const absOffset = Math.abs(offset);
  const hours = (0,_addLeadingZeros_js__rspack_import_2/* .addLeadingZeros */.F)(Math.trunc(absOffset / 60), 2);
  const minutes = (0,_addLeadingZeros_js__rspack_import_2/* .addLeadingZeros */.F)(absOffset % 60, 2);
  return sign + hours + delimiter + minutes;
}


},
33997(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  C: () => (lightFormatters)
});
/* import */ var _addLeadingZeros_js__rspack_import_0 = __webpack_require__(69666);
...
const lightFormatters = {
  ...
  y(date, token) {
    ...
    // Returns 1 for 1 BC (which is year 0 in JavaScript)
    const year = signedYear > 0 ? signedYear : 1 - signedYear;
    return (0,_addLeadingZeros_js__rspack_import_0/* .addLeadingZeros */.F)(token === "yy" ? year % 100 : year, token.length);
  },

  // Month
  M(date, token) {
    const month = date.getMonth();
    return token === "M" ? String(month + 1) : (0,_addLeadingZeros_js__rspack_import_0/* .addLeadingZeros */.F)(month + 1, 2);
  },

  // Day of the month
  d(date, token) {
    return (0,_addLeadingZeros_js__rspack_import_0/* .addLeadingZeros */.F)(date.getDate(), token.length);
  },
  ...
  // Hour [1-12]
  h(date, token) {
    return (0,_addLeadingZeros_js__rspack_import_0/* .addLeadingZeros */.F)(date.getHours() % 12 || 12, token.length);
  },

  // Hour [0-23]
  H(date, token) {
    return (0,_addLeadingZeros_js__rspack_import_0/* .addLeadingZeros */.F)(date.getHours(), token.length);
  },

  // Minute
  m(date, token) {
    return (0,_addLeadingZeros_js__rspack_import_0/* .addLeadingZeros */.F)(date.getMinutes(), token.length);
  },

  // Second
  s(date, token) {
    return (0,_addLeadingZeros_js__rspack_import_0/* .addLeadingZeros */.F)(date.getSeconds(), token.length);
  },
  ...
  S(date, token) {
    ...
    return (0,_addLeadingZeros_js__rspack_import_0/* .addLeadingZeros */.F)(fractionalSeconds, token.length);
  },
};


},
13853(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  m: () => (longFormatters)
});
...
93517(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
...
79764(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  Ss: () => (warnOrThrowProtectedError),
...
37198(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  m: () => (differenceInCalendarDays)
});
/* import */ var _lib_getTimezoneOffsetInMilliseconds_js__rspack_import_2 = __webpack_require__(93517);
/* import */ var _lib_normalizeDates_js__rspack_import_0 = __webpack_require__(14190);
/* import */ var _constants_js__rspack_import_3 = __webpack_require__(89174);
/* import */ var _startOfDay_js__rspack_import_1 = __webpack_require__(19630);
...
function differenceInCalendarDays(laterDate, earlierDate, options) {
  ...
  const laterStartOfDay = (0,_startOfDay_js__rspack_import_1/* .startOfDay */.o)(laterDate_);
  const earlierStartOfDay = (0,_startOfDay_js__rspack_import_1/* .startOfDay */.o)(earlierDate_);

  const laterTimestamp =
    +laterStartOfDay - (0,_lib_getTimezoneOffsetInMilliseconds_js__rspack_import_2/* .getTimezoneOffsetInMilliseconds */.G)(laterStartOfDay);
  const earlierTimestamp =
    +earlierStartOfDay - (0,_lib_getTimezoneOffsetInMilliseconds_js__rspack_import_2/* .getTimezoneOffsetInMilliseconds */.G)(earlierStartOfDay);

  // Round the number of days to the nearest integer because the number of
  // milliseconds in a day is not constant (e.g. it's different in the week of
  // the daylight saving time clock shift).
  return Math.round((laterTimestamp - earlierTimestamp) / _constants_js__rspack_import_3/* .millisecondsInDay */.w4);
}

// Fallback for modularized imports:
/* unused export default */ var __rspack_default_export = ((/* unused pure expression or super */ null && (differenceInCalendarDays)));


},
72664(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  GP: () => (format)
});
/* import */ var _lib_defaultLocale_js__rspack_import_1 = __webpack_require__(73492);
/* import */ var _lib_defaultOptions_js__rspack_import_0 = __webpack_require__(74499);
/* import */ var _lib_format_formatters_js__rspack_import_5 = __webpack_require__(27643);
/* import */ var _lib_format_longFormatters_js__rspack_import_4 = __webpack_require__(13853);
/* import */ var _lib_protectedTokens_js__rspack_import_6 = __webpack_require__(79764);
/* import */ var _isValid_js__rspack_import_3 = __webpack_require__(42205);
/* import */ var _toDate_js__rspack_import_2 = __webpack_require__(64494);
...
function format(date, formatStr, options) {
  ...
  const locale = options?.locale ?? defaultOptions.locale ?? _lib_defaultLocale_js__rspack_import_1/* .enUS */.c;
  ...
  const originalDate = (0,_toDate_js__rspack_import_2/* .toDate */.a)(date, options?.in);

  if (!(0,_isValid_js__rspack_import_3/* .isValid */.f)(originalDate)) {
  ...
  let parts = formatStr
    ...
    .map((substring) => {
      ...
      if (firstCharacter === "p" || firstCharacter === "P") {
        const longFormatter = _lib_format_longFormatters_js__rspack_import_4/* .longFormatters */.m[firstCharacter];
    ...
    .map((substring) => {
      ...
      if (_lib_format_formatters_js__rspack_import_5/* .formatters */._[firstCharacter]) {
    ...
    .map((part) => {
      ...
      if (
        (!options?.useAdditionalWeekYearTokens &&
          (0,_lib_protectedTokens_js__rspack_import_6/* .isProtectedWeekYearToken */.xM)(token)) ||
        (!options?.useAdditionalDayOfYearTokens &&
          (0,_lib_protectedTokens_js__rspack_import_6/* .isProtectedDayOfYearToken */.ef)(token))
      ) {
        (0,_lib_protectedTokens_js__rspack_import_6/* .warnOrThrowProtectedError */.Ss)(token, formatStr, String(date));
      }

      const formatter = _lib_format_formatters_js__rspack_import_5/* .formatters */._[token[0]];
...
// Fallback for modularized imports:
/* unused export default */ var __rspack_default_export = ((/* unused pure expression or super */ null && (format)));


},
50797(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  F: () => (getDayOfYear)
});
/* import */ var _differenceInCalendarDays_js__rspack_import_1 = __webpack_require__(37198);
/* import */ var _startOfYear_js__rspack_import_2 = __webpack_require__(17115);
/* import */ var _toDate_js__rspack_import_0 = __webpack_require__(64494);
...
function getDayOfYear(date, options) {
  ...
  const diff = (0,_differenceInCalendarDays_js__rspack_import_1/* .differenceInCalendarDays */.m)(_date, (0,_startOfYear_js__rspack_import_2/* .startOfYear */.D)(_date));
  const dayOfYear = diff + 1;
  return dayOfYear;
}

// Fallback for modularized imports:
/* unused export default */ var __rspack_default_export = ((/* unused pure expression or super */ null && (getDayOfYear)));


},
50418(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  s: () => (getISOWeek)
});
/* import */ var _constants_js__rspack_import_3 = __webpack_require__(89174);
/* import */ var _startOfISOWeek_js__rspack_import_1 = __webpack_require__(76525);
/* import */ var _startOfISOWeekYear_js__rspack_import_2 = __webpack_require__(40444);
/* import */ var _toDate_js__rspack_import_0 = __webpack_require__(64494);
...
function getISOWeek(date, options) {
  const _date = (0,_toDate_js__rspack_import_0/* .toDate */.a)(date, options?.in);
  const diff = +(0,_startOfISOWeek_js__rspack_import_1/* .startOfISOWeek */.b)(_date) - +(0,_startOfISOWeekYear_js__rspack_import_2/* .startOfISOWeekYear */.w)(_date);

  // Round the number of weeks to the nearest integer because the number of
  // milliseconds in a week is not constant (e.g. it's different in the week of
  // the daylight saving time clock shift).
  return Math.round(diff / _constants_js__rspack_import_3/* .millisecondsInWeek */.my) + 1;
}

// Fallback for modularized imports:
/* unused export default */ var __rspack_default_export = ((/* unused pure expression or super */ null && (getISOWeek)));


},
35119(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  p: () => (getISOWeekYear)
});
/* import */ var _constructFrom_js__rspack_import_1 = __webpack_require__(79694);
/* import */ var _startOfISOWeek_js__rspack_import_2 = __webpack_require__(76525);
/* import */ var _toDate_js__rspack_import_0 = __webpack_require__(64494);
...
function getISOWeekYear(date, options) {
  ...
  const fourthOfJanuaryOfNextYear = (0,_constructFrom_js__rspack_import_1/* .constructFrom */.w)(_date, 0);
  fourthOfJanuaryOfNextYear.setFullYear(year + 1, 0, 4);
  fourthOfJanuaryOfNextYear.setHours(0, 0, 0, 0);
  const startOfNextYear = (0,_startOfISOWeek_js__rspack_import_2/* .startOfISOWeek */.b)(fourthOfJanuaryOfNextYear);

  const fourthOfJanuaryOfThisYear = (0,_constructFrom_js__rspack_import_1/* .constructFrom */.w)(_date, 0);
  fourthOfJanuaryOfThisYear.setFullYear(year, 0, 4);
  fourthOfJanuaryOfThisYear.setHours(0, 0, 0, 0);
  const startOfThisYear = (0,_startOfISOWeek_js__rspack_import_2/* .startOfISOWeek */.b)(fourthOfJanuaryOfThisYear);
...
// Fallback for modularized imports:
/* unused export default */ var __rspack_default_export = ((/* unused pure expression or super */ null && (getISOWeekYear)));


},
12727(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  N: () => (getWeek)
});
/* import */ var _constants_js__rspack_import_3 = __webpack_require__(89174);
/* import */ var _startOfWeek_js__rspack_import_1 = __webpack_require__(71046);
/* import */ var _startOfWeekYear_js__rspack_import_2 = __webpack_require__(71179);
/* import */ var _toDate_js__rspack_import_0 = __webpack_require__(64494);
...
function getWeek(date, options) {
  const _date = (0,_toDate_js__rspack_import_0/* .toDate */.a)(date, options?.in);
  const diff = +(0,_startOfWeek_js__rspack_import_1/* .startOfWeek */.k)(_date, options) - +(0,_startOfWeekYear_js__rspack_import_2/* .startOfWeekYear */.b)(_date, options);
...
// Fallback for modularized imports:
/* unused export default */ var __rspack_default_export = ((/* unused pure expression or super */ null && (getWeek)));


},
54594(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  h: () => (getWeekYear)
});
/* import */ var _lib_defaultOptions_js__rspack_import_1 = __webpack_require__(74499);
/* import */ var _constructFrom_js__rspack_import_2 = __webpack_require__(79694);
/* import */ var _startOfWeek_js__rspack_import_3 = __webpack_require__(71046);
/* import */ var _toDate_js__rspack_import_0 = __webpack_require__(64494);
...
function getWeekYear(date, options) {
  ...
  const defaultOptions = (0,_lib_defaultOptions_js__rspack_import_1/* .getDefaultOptions */.q)();
  const firstWeekContainsDate =
    options?.firstWeekContainsDate ??
    options?.locale?.options?.firstWeekContainsDate ??
    defaultOptions.firstWeekContainsDate ??
  ...
  const firstWeekOfNextYear = (0,_constructFrom_js__rspack_import_2/* .constructFrom */.w)(options?.in || date, 0);
  firstWeekOfNextYear.setFullYear(year + 1, 0, firstWeekContainsDate);
  firstWeekOfNextYear.setHours(0, 0, 0, 0);
  const startOfNextYear = (0,_startOfWeek_js__rspack_import_3/* .startOfWeek */.k)(firstWeekOfNextYear, options);

  const firstWeekOfThisYear = (0,_constructFrom_js__rspack_import_2/* .constructFrom */.w)(options?.in || date, 0);
  firstWeekOfThisYear.setFullYear(year, 0, firstWeekContainsDate);
  firstWeekOfThisYear.setHours(0, 0, 0, 0);
  const startOfThisYear = (0,_startOfWeek_js__rspack_import_3/* .startOfWeek */.k)(firstWeekOfThisYear, options);
...
// Fallback for modularized imports:
/* unused export default */ var __rspack_default_export = ((/* unused pure expression or super */ null && (getWeekYear)));


},
75691(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  $: () => (isDate)
});
/**
...
// Fallback for modularized imports:
/* unused export default */ var __rspack_default_export = ((/* unused pure expression or super */ null && (isDate)));


},
42205(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  f: () => (isValid)
});
/* import */ var _isDate_js__rspack_import_0 = __webpack_require__(75691);
/* import */ var _toDate_js__rspack_import_1 = __webpack_require__(64494);
...
function isValid(date) {
  return !((!(0,_isDate_js__rspack_import_0/* .isDate */.$)(date) && typeof date !== "number") || isNaN(+(0,_toDate_js__rspack_import_1/* .toDate */.a)(date)));
}

// Fallback for modularized imports:
/* unused export default */ var __rspack_default_export = ((/* unused pure expression or super */ null && (isValid)));


},
55742(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  k: () => (buildFormatLongFn)
});
...
76232(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  o: () => (buildLocalizeFn)
});
/**
...
69570(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  A: () => (buildMatchFn)
});
...
95777(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  K: () => (buildMatchPatternFn)
});
...
73492(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  c: () => (enUS)
});
/* import */ var _en_US_lib_formatDistance_js__rspack_import_0 = __webpack_require__(82158);
/* import */ var _en_US_lib_formatLong_js__rspack_import_1 = __webpack_require__(68031);
/* import */ var _en_US_lib_formatRelative_js__rspack_import_2 = __webpack_require__(71137);
/* import */ var _en_US_lib_localize_js__rspack_import_3 = __webpack_require__(72073);
/* import */ var _en_US_lib_match_js__rspack_import_4 = __webpack_require__(39261);
...
const enUS = {
  code: "en-US",
  formatDistance: _en_US_lib_formatDistance_js__rspack_import_0/* .formatDistance */.B,
  formatLong: _en_US_lib_formatLong_js__rspack_import_1/* .formatLong */.s,
  formatRelative: _en_US_lib_formatRelative_js__rspack_import_2/* .formatRelative */.o,
  localize: _en_US_lib_localize_js__rspack_import_3/* .localize */.k,
  match: _en_US_lib_match_js__rspack_import_4/* .match */.Y,
  options: {
...
// Fallback for modularized imports:
/* unused export default */ var __rspack_default_export = ((/* unused pure expression or super */ null && (enUS)));


},
82158(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  B: () => (formatDistance)
});
...
68031(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  s: () => (formatLong)
});
/* import */ var _lib_buildFormatLongFn_js__rspack_import_0 = __webpack_require__(55742);
...
const formatLong = {
  date: (0,_lib_buildFormatLongFn_js__rspack_import_0/* .buildFormatLongFn */.k)({
    formats: dateFormats,
    defaultWidth: "full",
  }),

  time: (0,_lib_buildFormatLongFn_js__rspack_import_0/* .buildFormatLongFn */.k)({
    formats: timeFormats,
    defaultWidth: "full",
  }),

  dateTime: (0,_lib_buildFormatLongFn_js__rspack_import_0/* .buildFormatLongFn */.k)({
...
71137(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  o: () => (formatRelative)
});
...
72073(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  k: () => (localize)
});
/* import */ var _lib_buildLocalizeFn_js__rspack_import_0 = __webpack_require__(76232);
...
const localize = {
  ...
  era: (0,_lib_buildLocalizeFn_js__rspack_import_0/* .buildLocalizeFn */.o)({
    values: eraValues,
    defaultWidth: "wide",
  }),

  quarter: (0,_lib_buildLocalizeFn_js__rspack_import_0/* .buildLocalizeFn */.o)({
    values: quarterValues,
    defaultWidth: "wide",
    argumentCallback: (quarter) => quarter - 1,
  }),

  month: (0,_lib_buildLocalizeFn_js__rspack_import_0/* .buildLocalizeFn */.o)({
    values: monthValues,
    defaultWidth: "wide",
  }),

  day: (0,_lib_buildLocalizeFn_js__rspack_import_0/* .buildLocalizeFn */.o)({
    values: dayValues,
    defaultWidth: "wide",
  }),

  dayPeriod: (0,_lib_buildLocalizeFn_js__rspack_import_0/* .buildLocalizeFn */.o)({
...
39261(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  Y: () => (match)
});
/* import */ var _lib_buildMatchFn_js__rspack_import_1 = __webpack_require__(69570);
/* import */ var _lib_buildMatchPatternFn_js__rspack_import_0 = __webpack_require__(95777);
...
const match = {
  ordinalNumber: (0,_lib_buildMatchPatternFn_js__rspack_import_0/* .buildMatchPatternFn */.K)({
    matchPattern: matchOrdinalNumberPattern,
    parsePattern: parseOrdinalNumberPattern,
    valueCallback: (value) => parseInt(value, 10),
  }),

  era: (0,_lib_buildMatchFn_js__rspack_import_1/* .buildMatchFn */.A)({
  ...
  quarter: (0,_lib_buildMatchFn_js__rspack_import_1/* .buildMatchFn */.A)({
  ...
  month: (0,_lib_buildMatchFn_js__rspack_import_1/* .buildMatchFn */.A)({
  ...
  day: (0,_lib_buildMatchFn_js__rspack_import_1/* .buildMatchFn */.A)({
  ...
  dayPeriod: (0,_lib_buildMatchFn_js__rspack_import_1/* .buildMatchFn */.A)({
...
76525(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  b: () => (startOfISOWeek)
});
/* import */ var _startOfWeek_js__rspack_import_0 = __webpack_require__(71046);
...
function startOfISOWeek(date, options) {
  return (0,_startOfWeek_js__rspack_import_0/* .startOfWeek */.k)(date, { ...options, weekStartsOn: 1 });
}

// Fallback for modularized imports:
/* unused export default */ var __rspack_default_export = ((/* unused pure expression or super */ null && (startOfISOWeek)));


},
40444(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  w: () => (startOfISOWeekYear)
});
/* import */ var _constructFrom_js__rspack_import_1 = __webpack_require__(79694);
/* import */ var _getISOWeekYear_js__rspack_import_0 = __webpack_require__(35119);
/* import */ var _startOfISOWeek_js__rspack_import_2 = __webpack_require__(76525);
...
function startOfISOWeekYear(date, options) {
  const year = (0,_getISOWeekYear_js__rspack_import_0/* .getISOWeekYear */.p)(date, options);
  const fourthOfJanuary = (0,_constructFrom_js__rspack_import_1/* .constructFrom */.w)(options?.in || date, 0);
  fourthOfJanuary.setFullYear(year, 0, 4);
  fourthOfJanuary.setHours(0, 0, 0, 0);
  return (0,_startOfISOWeek_js__rspack_import_2/* .startOfISOWeek */.b)(fourthOfJanuary);
}

// Fallback for modularized imports:
/* unused export default */ var __rspack_default_export = ((/* unused pure expression or super */ null && (startOfISOWeekYear)));


},
71046(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  k: () => (startOfWeek)
});
/* import */ var _lib_defaultOptions_js__rspack_import_0 = __webpack_require__(74499);
...
71179(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  b: () => (startOfWeekYear)
});
/* import */ var _lib_defaultOptions_js__rspack_import_0 = __webpack_require__(74499);
...
function startOfWeekYear(date, options) {
  ...
  const year = (0,_getWeekYear_js__rspack_import_1/* .getWeekYear */.h)(date, options);
  const firstWeek = (0,_constructFrom_js__rspack_import_2/* .constructFrom */.w)(options?.in || date, 0);
  firstWeek.setFullYear(year, 0, firstWeekContainsDate);
  firstWeek.setHours(0, 0, 0, 0);
  const _date = (0,_startOfWeek_js__rspack_import_3/* .startOfWeek */.k)(firstWeek, options);
  return _date;
}

// Fallback for modularized imports:
/* unused export default */ var __rspack_default_export = ((/* unused pure expression or super */ null && (startOfWeekYear)));


},
17115(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  D: () => (startOfYear)
});
/* import */ var _toDate_js__rspack_import_0 = __webpack_require__(64494);
...
function startOfYear(date, options) {
  const date_ = (0,_toDate_js__rspack_import_0/* .toDate */.a)(date, options?.in);
...
// Fallback for modularized imports:
/* unused export default */ var __rspack_default_export = ((/* unused pure expression or super */ null && (startOfYear)));
...
var isArguments = __webpack_require__(37843);
...
/* import */ var _debounce_js__rspack_import_1 = __webpack_require__(57424);
