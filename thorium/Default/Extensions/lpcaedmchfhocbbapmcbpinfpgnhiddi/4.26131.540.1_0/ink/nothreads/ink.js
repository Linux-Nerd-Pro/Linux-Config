...
var ASM_CONSTS = {
  ...
  315227: ($0, $1, $2) => {
    if (window.inkHostRegistry[$2]) {
      window.inkHostRegistry[$2].onAccessibilityData(new Uint8Array(HEAPU8.subarray($0, $0 + $1)));
    }
  },
  315362: $0 => {
    if (window.inkHostRegistry[$0]) {
  ...
  316159: ($0, $1, $2, $3, $4, $5, $6, $7, $8) => {
    if (window.inkHostRegistry[$8]) {
      window.inkHostRegistry[$8].onImageExported($0, $1, $2, new Uint8ClampedArray(HEAPU8.subarray($3, $3 + $4)), $5, $6, UTF8ToString($7));
    }
  },
  316335: ($0, $1, $2) => {
    if (window.inkHostRegistry[$2]) {
...
var _shouldOnlyDrawLineToolUpdate, _draw, _malloc, _free, ___getTypeName, _setThrew, __emscripten_stack_restore, _emscripten_stack_get_current, dynCall_viii, dynCall_i, dynCall_iiidd, dynCall_iidd, dynCall_ii, dynCall_vi, dynCall_iii, dynCall_vii, dynCall_iiiii, dynCall_iiii, dynCall_iiiiii, dynCall_viiii, dynCall_iiiifi, dynCall_iiiiifi, dynCall_iiff, dynCall_iiiff, dynCall_fi, dynCall_fii, dynCall_viiiii, dynCall_vid, dynCall_viid, dynCall_di, dynCall_d, dynCall_vif, dynCall_viif, dynCall_dii, dynCall_v, dynCall_viiiiii, dynCall_iidi, dynCall_viiif, dynCall_viiiif, dynCall_viiiiiiii, dynCall_iiiijij, dynCall_viidi, dynCall_viifi, dynCall_viiifi, dynCall_viiid, dynCall_fiiif, dynCall_viidiff, dynCall_iiidi, dynCall_vidi, dynCall_vidii, dynCall_vifidi, dynCall_viiiiiii, dynCall_fif, dynCall_viidii, dynCall_fiii, dynCall_iiiif, dynCall_viiiff, dynCall_iiiiid, dynCall_iiiid, dynCall_vffff, dynCall_vf, dynCall_viiiiiiiii, dynCall_vff, dynCall_vfi, dynCall_viff, dynCall_vifff, dynCall_viffff, dynCall_vfff, dynCall_viiiiiiiiii, dynCall_viiiiiiiiiii, dynCall_iiij, dynCall_viij, dynCall_iiiiiiii, dynCall_ji, dynCall_viijii, dynCall_vij, dynCall_vijjj, dynCall_vj, dynCall_iijjiiii, dynCall_jiji, dynCall_iiiiiiiii, dynCall_iiiiiii, dynCall_iiiiij, dynCall_iiiiijj, dynCall_iiiiiijj, memory, _kVersionStampBuildChangelistStr, _kVersionStampCitcSnapshotStr, _kVersionStampCitcWorkspaceIdStr, _kVersionStampSourceUriStr, _kVersionStampBuildClientStr, _kVersionStampBuildClientMintStatusStr, _kVersionStampBuildCompilerStr, _kVersionStampBuildDateTimePstStr, _kVersionStampBuildDepotPathStr, _kVersionStampBuildIdStr, _kVersionStampBuildInfoStr, _kVersionStampBuildLabelStr, _kVersionStampBuildTargetStr, _kVersionStampBuildTimestampStr, _kVersionStampBuildToolStr, _kVersionStampG3BuildTargetStr, _kVersionStampVerifiableStr, _kVersionStampBuildFdoTypeStr, _kVersionStampBuildBaselineChangelistStr, _kVersionStampBuildLtoTypeStr, _kVersionStampBuildPropellerTypeStr, _kVersionStampBuildPghoTypeStr, _kVersionStampBuildUsernameStr, _kVersionStampBuildHostnameStr, _kVersionStampBuildDirectoryStr, _kVersionStampBuildChangelistInt, _kVersionStampCitcSnapshotInt, _kVersionStampBuildClientMintStatusInt, _kVersionStampBuildTimestampInt, _kVersionStampVerifiableInt, _kVersionStampBuildCoverageEnabledInt, _kVersionStampBuildBaselineChangelistInt, _kVersionStampPrecookedTimestampStr, _kVersionStampPrecookedClientInfoStr, __indirect_function_table, wasmMemory, wasmTable;

function assignWasmExports(wasmExports) {
  _shouldOnlyDrawLineToolUpdate = Module["_shouldOnlyDrawLineToolUpdate"] = wasmExports["ng"];
  _draw = Module["_draw"] = wasmExports["og"];
  _malloc = wasmExports["pg"];
  _free = wasmExports["qg"];
  ___getTypeName = wasmExports["rg"];
  _setThrew = wasmExports["sg"];
  __emscripten_stack_restore = wasmExports["tg"];
  _emscripten_stack_get_current = wasmExports["ug"];
  dynCall_viii = dynCalls["viii"] = wasmExports["vg"];
  dynCall_i = dynCalls["i"] = wasmExports["wg"];
  dynCall_iiidd = dynCalls["iiidd"] = wasmExports["xg"];
  dynCall_iidd = dynCalls["iidd"] = wasmExports["yg"];
  dynCall_ii = dynCalls["ii"] = wasmExports["zg"];
  dynCall_vi = dynCalls["vi"] = wasmExports["Ag"];
  dynCall_iii = dynCalls["iii"] = wasmExports["Bg"];
  dynCall_vii = dynCalls["vii"] = wasmExports["Cg"];
  dynCall_iiiii = dynCalls["iiiii"] = wasmExports["Dg"];
  dynCall_iiii = dynCalls["iiii"] = wasmExports["Eg"];
  dynCall_iiiiii = dynCalls["iiiiii"] = wasmExports["Fg"];
  dynCall_viiii = dynCalls["viiii"] = wasmExports["Gg"];
  dynCall_iiiifi = dynCalls["iiiifi"] = wasmExports["Hg"];
  dynCall_iiiiifi = dynCalls["iiiiifi"] = wasmExports["Ig"];
  dynCall_iiff = dynCalls["iiff"] = wasmExports["Jg"];
  dynCall_iiiff = dynCalls["iiiff"] = wasmExports["Kg"];
  dynCall_fi = dynCalls["fi"] = wasmExports["Lg"];
  dynCall_fii = dynCalls["fii"] = wasmExports["Mg"];
  dynCall_viiiii = dynCalls["viiiii"] = wasmExports["Ng"];
  dynCall_vid = dynCalls["vid"] = wasmExports["Og"];
  dynCall_viid = dynCalls["viid"] = wasmExports["Pg"];
  dynCall_di = dynCalls["di"] = wasmExports["Qg"];
  dynCall_d = dynCalls["d"] = wasmExports["Rg"];
  dynCall_vif = dynCalls["vif"] = wasmExports["Sg"];
  dynCall_viif = dynCalls["viif"] = wasmExports["Tg"];
  dynCall_dii = dynCalls["dii"] = wasmExports["Ug"];
  dynCall_v = dynCalls["v"] = wasmExports["Vg"];
  dynCall_viiiiii = dynCalls["viiiiii"] = wasmExports["Wg"];
  dynCall_iidi = dynCalls["iidi"] = wasmExports["Xg"];
  dynCall_viiif = dynCalls["viiif"] = wasmExports["Yg"];
  dynCall_viiiif = dynCalls["viiiif"] = wasmExports["Zg"];
  dynCall_viiiiiiii = dynCalls["viiiiiiii"] = wasmExports["_g"];
  dynCall_iiiijij = dynCalls["iiiijij"] = wasmExports["$g"];
  dynCall_viidi = dynCalls["viidi"] = wasmExports["ah"];
  dynCall_viifi = dynCalls["viifi"] = wasmExports["bh"];
  dynCall_viiifi = dynCalls["viiifi"] = wasmExports["ch"];
  dynCall_viiid = dynCalls["viiid"] = wasmExports["dh"];
  dynCall_fiiif = dynCalls["fiiif"] = wasmExports["eh"];
  dynCall_viidiff = dynCalls["viidiff"] = wasmExports["fh"];
  dynCall_iiidi = dynCalls["iiidi"] = wasmExports["gh"];
  dynCall_vidi = dynCalls["vidi"] = wasmExports["hh"];
  dynCall_vidii = dynCalls["vidii"] = wasmExports["ih"];
  dynCall_vifidi = dynCalls["vifidi"] = wasmExports["jh"];
  dynCall_viiiiiii = dynCalls["viiiiiii"] = wasmExports["kh"];
  dynCall_fif = dynCalls["fif"] = wasmExports["lh"];
  dynCall_viidii = dynCalls["viidii"] = wasmExports["mh"];
  dynCall_fiii = dynCalls["fiii"] = wasmExports["nh"];
  dynCall_iiiif = dynCalls["iiiif"] = wasmExports["oh"];
  dynCall_viiiff = dynCalls["viiiff"] = wasmExports["ph"];
  dynCall_iiiiid = dynCalls["iiiiid"] = wasmExports["qh"];
  dynCall_iiiid = dynCalls["iiiid"] = wasmExports["rh"];
  dynCall_vffff = dynCalls["vffff"] = wasmExports["sh"];
  dynCall_vf = dynCalls["vf"] = wasmExports["th"];
  dynCall_viiiiiiiii = dynCalls["viiiiiiiii"] = wasmExports["uh"];
  dynCall_vff = dynCalls["vff"] = wasmExports["vh"];
  dynCall_vfi = dynCalls["vfi"] = wasmExports["wh"];
  dynCall_viff = dynCalls["viff"] = wasmExports["xh"];
  dynCall_vifff = dynCalls["vifff"] = wasmExports["yh"];
  dynCall_viffff = dynCalls["viffff"] = wasmExports["zh"];
  dynCall_vfff = dynCalls["vfff"] = wasmExports["Ah"];
  dynCall_viiiiiiiiii = dynCalls["viiiiiiiiii"] = wasmExports["Bh"];
  dynCall_viiiiiiiiiii = dynCalls["viiiiiiiiiii"] = wasmExports["Ch"];
  dynCall_iiij = dynCalls["iiij"] = wasmExports["Dh"];
  dynCall_viij = dynCalls["viij"] = wasmExports["Eh"];
  dynCall_iiiiiiii = dynCalls["iiiiiiii"] = wasmExports["Fh"];
  dynCall_ji = dynCalls["ji"] = wasmExports["Gh"];
  dynCall_viijii = dynCalls["viijii"] = wasmExports["Hh"];
  dynCall_vij = dynCalls["vij"] = wasmExports["Ih"];
  dynCall_vijjj = dynCalls["vijjj"] = wasmExports["Jh"];
  dynCall_vj = dynCalls["vj"] = wasmExports["Kh"];
  dynCall_iijjiiii = dynCalls["iijjiiii"] = wasmExports["Lh"];
  dynCall_jiji = dynCalls["jiji"] = wasmExports["Mh"];
  dynCall_iiiiiiiii = dynCalls["iiiiiiiii"] = wasmExports["Nh"];
  dynCall_iiiiiii = dynCalls["iiiiiii"] = wasmExports["Oh"];
  dynCall_iiiiij = dynCalls["iiiiij"] = wasmExports["Ph"];
  dynCall_iiiiijj = dynCalls["iiiiijj"] = wasmExports["Qh"];
  dynCall_iiiiiijj = dynCalls["iiiiiijj"] = wasmExports["Rh"];
  memory = wasmMemory = wasmExports["Ef"];
  _kVersionStampBuildChangelistStr = Module["_kVersionStampBuildChangelistStr"] = wasmExports["Gf"].value;
  _kVersionStampCitcSnapshotStr = Module["_kVersionStampCitcSnapshotStr"] = wasmExports["Hf"].value;
  _kVersionStampCitcWorkspaceIdStr = Module["_kVersionStampCitcWorkspaceIdStr"] = wasmExports["If"].value;
  _kVersionStampSourceUriStr = Module["_kVersionStampSourceUriStr"] = wasmExports["Jf"].value;
  _kVersionStampBuildClientStr = Module["_kVersionStampBuildClientStr"] = wasmExports["Kf"].value;
  _kVersionStampBuildClientMintStatusStr = Module["_kVersionStampBuildClientMintStatusStr"] = wasmExports["Lf"].value;
  _kVersionStampBuildCompilerStr = Module["_kVersionStampBuildCompilerStr"] = wasmExports["Mf"].value;
  _kVersionStampBuildDateTimePstStr = Module["_kVersionStampBuildDateTimePstStr"] = wasmExports["Nf"].value;
  _kVersionStampBuildDepotPathStr = Module["_kVersionStampBuildDepotPathStr"] = wasmExports["Of"].value;
  _kVersionStampBuildIdStr = Module["_kVersionStampBuildIdStr"] = wasmExports["Pf"].value;
  _kVersionStampBuildInfoStr = Module["_kVersionStampBuildInfoStr"] = wasmExports["Qf"].value;
  _kVersionStampBuildLabelStr = Module["_kVersionStampBuildLabelStr"] = wasmExports["Rf"].value;
  _kVersionStampBuildTargetStr = Module["_kVersionStampBuildTargetStr"] = wasmExports["Sf"].value;
  _kVersionStampBuildTimestampStr = Module["_kVersionStampBuildTimestampStr"] = wasmExports["Tf"].value;
  _kVersionStampBuildToolStr = Module["_kVersionStampBuildToolStr"] = wasmExports["Uf"].value;
  _kVersionStampG3BuildTargetStr = Module["_kVersionStampG3BuildTargetStr"] = wasmExports["Vf"].value;
  _kVersionStampVerifiableStr = Module["_kVersionStampVerifiableStr"] = wasmExports["Wf"].value;
  _kVersionStampBuildFdoTypeStr = Module["_kVersionStampBuildFdoTypeStr"] = wasmExports["Xf"].value;
  _kVersionStampBuildBaselineChangelistStr = Module["_kVersionStampBuildBaselineChangelistStr"] = wasmExports["Yf"].value;
  _kVersionStampBuildLtoTypeStr = Module["_kVersionStampBuildLtoTypeStr"] = wasmExports["Zf"].value;
  _kVersionStampBuildPropellerTypeStr = Module["_kVersionStampBuildPropellerTypeStr"] = wasmExports["_f"].value;
  _kVersionStampBuildPghoTypeStr = Module["_kVersionStampBuildPghoTypeStr"] = wasmExports["$f"].value;
  _kVersionStampBuildUsernameStr = Module["_kVersionStampBuildUsernameStr"] = wasmExports["ag"].value;
  _kVersionStampBuildHostnameStr = Module["_kVersionStampBuildHostnameStr"] = wasmExports["bg"].value;
  _kVersionStampBuildDirectoryStr = Module["_kVersionStampBuildDirectoryStr"] = wasmExports["cg"].value;
  _kVersionStampBuildChangelistInt = Module["_kVersionStampBuildChangelistInt"] = wasmExports["dg"].value;
  _kVersionStampCitcSnapshotInt = Module["_kVersionStampCitcSnapshotInt"] = wasmExports["eg"].value;
  _kVersionStampBuildClientMintStatusInt = Module["_kVersionStampBuildClientMintStatusInt"] = wasmExports["fg"].value;
  _kVersionStampBuildTimestampInt = Module["_kVersionStampBuildTimestampInt"] = wasmExports["gg"].value;
  _kVersionStampVerifiableInt = Module["_kVersionStampVerifiableInt"] = wasmExports["hg"].value;
  _kVersionStampBuildCoverageEnabledInt = Module["_kVersionStampBuildCoverageEnabledInt"] = wasmExports["ig"].value;
  _kVersionStampBuildBaselineChangelistInt = Module["_kVersionStampBuildBaselineChangelistInt"] = wasmExports["jg"].value;
  _kVersionStampPrecookedTimestampStr = Module["_kVersionStampPrecookedTimestampStr"] = wasmExports["kg"].value;
  _kVersionStampPrecookedClientInfoStr = Module["_kVersionStampPrecookedClientInfoStr"] = wasmExports["lg"].value;
  __indirect_function_table = wasmTable = wasmExports["mg"];
}

var wasmImports = {
  /** @export */ Df: ___syscall_openat,
  /** @export */ yf: __abort_js,
  /** @export */ xf: __embind_finalize_value_array,
  /** @export */ B: __embind_finalize_value_object,
  /** @export */ P: __embind_register_bigint,
  /** @export */ wf: __embind_register_bool,
  /** @export */ e: __embind_register_class,
  /** @export */ f: __embind_register_class_constructor,
  /** @export */ b: __embind_register_class_function,
  /** @export */ c: __embind_register_class_property,
  /** @export */ vf: __embind_register_emval,
  /** @export */ l: __embind_register_enum,
  /** @export */ a: __embind_register_enum_value,
  /** @export */ I: __embind_register_float,
  /** @export */ u: __embind_register_function,
  /** @export */ q: __embind_register_integer,
  /** @export */ A: __embind_register_iterable,
  /** @export */ m: __embind_register_memory_view,
  /** @export */ t: __embind_register_optional,
  /** @export */ uf: __embind_register_std_string,
  /** @export */ z: __embind_register_std_wstring,
  /** @export */ tf: __embind_register_value_array,
  /** @export */ H: __embind_register_value_array_element,
  /** @export */ y: __embind_register_value_object,
  /** @export */ p: __embind_register_value_object_field,
  /** @export */ sf: __embind_register_void,
  /** @export */ rf: __emscripten_log_formatted,
  /** @export */ qf: __emscripten_throw_longjmp,
  /** @export */ j: __emval_create_invoker,
  /** @export */ d: __emval_decref,
  /** @export */ w: __emval_get_global,
  /** @export */ o: __emval_get_property,
  /** @export */ k: __emval_incref,
  /** @export */ pf: __emval_instanceof,
  ...
  /** @export */ G: _eglChooseConfig,
  /** @export */ nf: _eglCreateContext,
  /** @export */ mf: _eglCreateWindowSurface,
  /** @export */ F: _eglDestroyContext,
  /** @export */ E: _eglDestroySurface,
  /** @export */ lf: _eglGetCurrentContext,
  /** @export */ kf: _eglGetCurrentDisplay,
  /** @export */ v: _eglGetCurrentSurface,
  /** @export */ jf: _eglGetDisplay,
  /** @export */ hf: _eglInitialize,
  /** @export */ gf: _eglMakeCurrent,
  /** @export */ ff: _eglReleaseThread,
  /** @export */ ef: _eglSwapBuffers,
  /** @export */ df: em_severity_log,
  /** @export */ x: _emscripten_asm_const_int,
  /** @export */ g: _emscripten_asm_const_int_sync_on_main_thread,
  /** @export */ cf: _emscripten_async_call,
  /** @export */ bf: _emscripten_date_now,
  /** @export */ D: _emscripten_errn,
  /** @export */ af: _emscripten_get_heap_max,
  /** @export */ s: _emscripten_get_now,
  /** @export */ $e: _emscripten_glActiveTexture,
  /** @export */ _e: _emscripten_glAttachShader,
  /** @export */ Ze: _emscripten_glBeginQuery,
  /** @export */ Ye: _emscripten_glBeginQueryEXT,
  /** @export */ Xe: _emscripten_glBeginTransformFeedback,
  /** @export */ We: _emscripten_glBindAttribLocation,
  /** @export */ Ve: _emscripten_glBindBuffer,
  /** @export */ Ue: _emscripten_glBindBufferBase,
  /** @export */ Te: _emscripten_glBindBufferRange,
  /** @export */ Se: _emscripten_glBindFramebuffer,
  /** @export */ Re: _emscripten_glBindRenderbuffer,
  /** @export */ Qe: _emscripten_glBindSampler,
  /** @export */ Pe: _emscripten_glBindTexture,
  /** @export */ Oe: _emscripten_glBindTransformFeedback,
  /** @export */ Ne: _emscripten_glBindVertexArray,
  /** @export */ Me: _emscripten_glBindVertexArrayOES,
  /** @export */ Le: _emscripten_glBlendColor,
  /** @export */ Ke: _emscripten_glBlendEquation,
  /** @export */ Je: _emscripten_glBlendEquationSeparate,
  /** @export */ Ie: _emscripten_glBlendFunc,
  /** @export */ He: _emscripten_glBlendFuncSeparate,
  /** @export */ Ge: _emscripten_glBlitFramebuffer,
  /** @export */ Fe: _emscripten_glBufferData,
  /** @export */ Ee: _emscripten_glBufferSubData,
  /** @export */ De: _emscripten_glCheckFramebufferStatus,
  /** @export */ Ce: _emscripten_glClear,
  /** @export */ Be: _emscripten_glClearBufferfi,
  /** @export */ Ae: _emscripten_glClearBufferfv,
  /** @export */ ze: _emscripten_glClearBufferiv,
  /** @export */ ye: _emscripten_glClearBufferuiv,
  /** @export */ xe: _emscripten_glClearColor,
  /** @export */ we: _emscripten_glClearDepthf,
  /** @export */ ve: _emscripten_glClearStencil,
  /** @export */ N: _emscripten_glClientWaitSync,
  /** @export */ ue: _emscripten_glClipControlEXT,
  /** @export */ te: _emscripten_glColorMask,
  /** @export */ se: _emscripten_glCompileShader,
  /** @export */ re: _emscripten_glCompressedTexImage2D,
  /** @export */ qe: _emscripten_glCompressedTexImage3D,
  /** @export */ pe: _emscripten_glCompressedTexSubImage2D,
  /** @export */ oe: _emscripten_glCompressedTexSubImage3D,
  /** @export */ ne: _emscripten_glCopyBufferSubData,
  /** @export */ me: _emscripten_glCopyTexImage2D,
  /** @export */ le: _emscripten_glCopyTexSubImage2D,
  /** @export */ ke: _emscripten_glCopyTexSubImage3D,
  /** @export */ je: _emscripten_glCreateProgram,
  /** @export */ ie: _emscripten_glCreateShader,
  /** @export */ he: _emscripten_glCullFace,
  /** @export */ ge: _emscripten_glDeleteBuffers,
  /** @export */ fe: _emscripten_glDeleteFramebuffers,
  /** @export */ ee: _emscripten_glDeleteProgram,
  /** @export */ de: _emscripten_glDeleteQueries,
  /** @export */ ce: _emscripten_glDeleteQueriesEXT,
  /** @export */ be: _emscripten_glDeleteRenderbuffers,
  /** @export */ ae: _emscripten_glDeleteSamplers,
  /** @export */ $d: _emscripten_glDeleteShader,
  /** @export */ _d: _emscripten_glDeleteSync,
  /** @export */ Zd: _emscripten_glDeleteTextures,
  /** @export */ Yd: _emscripten_glDeleteTransformFeedbacks,
  /** @export */ Xd: _emscripten_glDeleteVertexArrays,
  /** @export */ Wd: _emscripten_glDeleteVertexArraysOES,
  /** @export */ Vd: _emscripten_glDepthFunc,
  /** @export */ Ud: _emscripten_glDepthMask,
  /** @export */ Td: _emscripten_glDepthRangef,
  /** @export */ Sd: _emscripten_glDetachShader,
  /** @export */ Rd: _emscripten_glDisable,
  /** @export */ Qd: _emscripten_glDisableVertexAttribArray,
  /** @export */ Pd: _emscripten_glDrawArrays,
  /** @export */ Od: _emscripten_glDrawArraysInstanced,
  /** @export */ Nd: _emscripten_glDrawArraysInstancedANGLE,
  /** @export */ Md: _emscripten_glDrawArraysInstancedARB,
  /** @export */ Ld: _emscripten_glDrawArraysInstancedEXT,
  /** @export */ Kd: _emscripten_glDrawArraysInstancedNV,
  /** @export */ Jd: _emscripten_glDrawBuffers,
  /** @export */ Id: _emscripten_glDrawBuffersEXT,
  /** @export */ Hd: _emscripten_glDrawBuffersWEBGL,
  /** @export */ Gd: _emscripten_glDrawElements,
  /** @export */ Fd: _emscripten_glDrawElementsInstanced,
  /** @export */ Ed: _emscripten_glDrawElementsInstancedANGLE,
  /** @export */ Dd: _emscripten_glDrawElementsInstancedARB,
  /** @export */ Cd: _emscripten_glDrawElementsInstancedEXT,
  /** @export */ Bd: _emscripten_glDrawElementsInstancedNV,
  /** @export */ Ad: _emscripten_glDrawRangeElements,
  /** @export */ zd: _emscripten_glEnable,
  /** @export */ yd: _emscripten_glEnableVertexAttribArray,
  /** @export */ xd: _emscripten_glEndQuery,
  /** @export */ wd: _emscripten_glEndQueryEXT,
  /** @export */ vd: _emscripten_glEndTransformFeedback,
  /** @export */ ud: _emscripten_glFenceSync,
  /** @export */ td: _emscripten_glFinish,
  /** @export */ sd: _emscripten_glFlush,
  /** @export */ rd: _emscripten_glFramebufferRenderbuffer,
  /** @export */ qd: _emscripten_glFramebufferTexture2D,
  /** @export */ pd: _emscripten_glFramebufferTextureLayer,
  /** @export */ od: _emscripten_glFrontFace,
  /** @export */ nd: _emscripten_glGenBuffers,
  /** @export */ md: _emscripten_glGenFramebuffers,
  /** @export */ ld: _emscripten_glGenQueries,
  /** @export */ kd: _emscripten_glGenQueriesEXT,
  /** @export */ jd: _emscripten_glGenRenderbuffers,
  /** @export */ id: _emscripten_glGenSamplers,
  /** @export */ hd: _emscripten_glGenTextures,
  /** @export */ gd: _emscripten_glGenTransformFeedbacks,
  /** @export */ fd: _emscripten_glGenVertexArrays,
  /** @export */ ed: _emscripten_glGenVertexArraysOES,
  /** @export */ dd: _emscripten_glGenerateMipmap,
  /** @export */ cd: _emscripten_glGetActiveAttrib,
  /** @export */ bd: _emscripten_glGetActiveUniform,
  /** @export */ ad: _emscripten_glGetActiveUniformBlockName,
  /** @export */ $c: _emscripten_glGetActiveUniformBlockiv,
  /** @export */ _c: _emscripten_glGetActiveUniformsiv,
  /** @export */ Zc: _emscripten_glGetAttachedShaders,
  /** @export */ Yc: _emscripten_glGetAttribLocation,
  /** @export */ Xc: _emscripten_glGetBooleanv,
  /** @export */ Wc: _emscripten_glGetBufferParameteri64v,
  /** @export */ Vc: _emscripten_glGetBufferParameteriv,
  /** @export */ Uc: _emscripten_glGetError,
  /** @export */ Tc: _emscripten_glGetFloatv,
  /** @export */ Sc: _emscripten_glGetFragDataLocation,
  /** @export */ Rc: _emscripten_glGetFramebufferAttachmentParameteriv,
  /** @export */ Qc: _emscripten_glGetInteger64i_v,
  /** @export */ Pc: _emscripten_glGetInteger64v,
  /** @export */ Oc: _emscripten_glGetIntegeri_v,
  /** @export */ Nc: _emscripten_glGetIntegerv,
  /** @export */ Mc: _emscripten_glGetInternalformativ,
  /** @export */ Lc: _emscripten_glGetProgramBinary,
  /** @export */ Kc: _emscripten_glGetProgramInfoLog,
  /** @export */ Jc: _emscripten_glGetProgramiv,
  /** @export */ Ic: _emscripten_glGetQueryObjecti64vEXT,
  /** @export */ Hc: _emscripten_glGetQueryObjectivEXT,
  /** @export */ Gc: _emscripten_glGetQueryObjectui64vEXT,
  /** @export */ Fc: _emscripten_glGetQueryObjectuiv,
  /** @export */ Ec: _emscripten_glGetQueryObjectuivEXT,
  /** @export */ Dc: _emscripten_glGetQueryiv,
  /** @export */ Cc: _emscripten_glGetQueryivEXT,
  /** @export */ Bc: _emscripten_glGetRenderbufferParameteriv,
  /** @export */ Ac: _emscripten_glGetSamplerParameterfv,
  /** @export */ zc: _emscripten_glGetSamplerParameteriv,
  ...
  /** @export */ vc: _emscripten_glGetShaderiv,
  /** @export */ uc: _emscripten_glGetString,
  /** @export */ tc: _emscripten_glGetStringi,
  /** @export */ sc: _emscripten_glGetSynciv,
  /** @export */ rc: _emscripten_glGetTexParameterfv,
  /** @export */ qc: _emscripten_glGetTexParameteriv,
  /** @export */ pc: _emscripten_glGetTransformFeedbackVarying,
  /** @export */ oc: _emscripten_glGetUniformBlockIndex,
  /** @export */ nc: _emscripten_glGetUniformIndices,
  /** @export */ mc: _emscripten_glGetUniformLocation,
  /** @export */ lc: _emscripten_glGetUniformfv,
  /** @export */ kc: _emscripten_glGetUniformiv,
  /** @export */ jc: _emscripten_glGetUniformuiv,
  /** @export */ ic: _emscripten_glGetVertexAttribIiv,
  /** @export */ hc: _emscripten_glGetVertexAttribIuiv,
  /** @export */ gc: _emscripten_glGetVertexAttribPointerv,
  /** @export */ fc: _emscripten_glGetVertexAttribfv,
  /** @export */ ec: _emscripten_glGetVertexAttribiv,
  /** @export */ dc: _emscripten_glHint,
  /** @export */ cc: _emscripten_glInvalidateFramebuffer,
  /** @export */ bc: _emscripten_glInvalidateSubFramebuffer,
  /** @export */ ac: _emscripten_glIsBuffer,
  /** @export */ $b: _emscripten_glIsEnabled,
  /** @export */ _b: _emscripten_glIsFramebuffer,
  /** @export */ Zb: _emscripten_glIsProgram,
  /** @export */ Yb: _emscripten_glIsQuery,
  /** @export */ Xb: _emscripten_glIsQueryEXT,
  /** @export */ Wb: _emscripten_glIsRenderbuffer,
  /** @export */ Vb: _emscripten_glIsSampler,
  /** @export */ Ub: _emscripten_glIsShader,
  /** @export */ Tb: _emscripten_glIsSync,
  /** @export */ Sb: _emscripten_glIsTexture,
  /** @export */ Rb: _emscripten_glIsTransformFeedback,
  /** @export */ Qb: _emscripten_glIsVertexArray,
  /** @export */ Pb: _emscripten_glIsVertexArrayOES,
  /** @export */ Ob: _emscripten_glLineWidth,
  /** @export */ Nb: _emscripten_glLinkProgram,
  /** @export */ Mb: _emscripten_glPauseTransformFeedback,
  /** @export */ Lb: _emscripten_glPixelStorei,
  /** @export */ Kb: _emscripten_glPolygonModeWEBGL,
  /** @export */ Jb: _emscripten_glPolygonOffset,
  /** @export */ Ib: _emscripten_glPolygonOffsetClampEXT,
  /** @export */ Hb: _emscripten_glProgramBinary,
  /** @export */ Gb: _emscripten_glProgramParameteri,
  /** @export */ Fb: _emscripten_glQueryCounterEXT,
  /** @export */ Eb: _emscripten_glReadBuffer,
  /** @export */ Db: _emscripten_glReadPixels,
  /** @export */ Cb: _emscripten_glReleaseShaderCompiler,
  /** @export */ Bb: _emscripten_glRenderbufferStorage,
  /** @export */ Ab: _emscripten_glRenderbufferStorageMultisample,
  /** @export */ zb: _emscripten_glResumeTransformFeedback,
  /** @export */ yb: _emscripten_glSampleCoverage,
  /** @export */ xb: _emscripten_glSamplerParameterf,
  /** @export */ wb: _emscripten_glSamplerParameterfv,
  /** @export */ vb: _emscripten_glSamplerParameteri,
  /** @export */ ub: _emscripten_glSamplerParameteriv,
  /** @export */ tb: _emscripten_glScissor,
  /** @export */ sb: _emscripten_glShaderBinary,
  /** @export */ rb: _emscripten_glShaderSource,
  /** @export */ qb: _emscripten_glStencilFunc,
  /** @export */ pb: _emscripten_glStencilFuncSeparate,
  /** @export */ ob: _emscripten_glStencilMask,
  /** @export */ nb: _emscripten_glStencilMaskSeparate,
  /** @export */ mb: _emscripten_glStencilOp,
  /** @export */ lb: _emscripten_glStencilOpSeparate,
  /** @export */ kb: _emscripten_glTexImage2D,
  /** @export */ jb: _emscripten_glTexImage3D,
  /** @export */ ib: _emscripten_glTexParameterf,
  /** @export */ hb: _emscripten_glTexParameterfv,
  /** @export */ gb: _emscripten_glTexParameteri,
  /** @export */ fb: _emscripten_glTexParameteriv,
  /** @export */ eb: _emscripten_glTexStorage2D,
  /** @export */ db: _emscripten_glTexStorage3D,
  /** @export */ cb: _emscripten_glTexSubImage2D,
  /** @export */ bb: _emscripten_glTexSubImage3D,
  /** @export */ ab: _emscripten_glTransformFeedbackVaryings,
  /** @export */ $a: _emscripten_glUniform1f,
  /** @export */ _a: _emscripten_glUniform1fv,
  /** @export */ Za: _emscripten_glUniform1i,
  /** @export */ Ya: _emscripten_glUniform1iv,
  /** @export */ Xa: _emscripten_glUniform1ui,
  /** @export */ Wa: _emscripten_glUniform1uiv,
  /** @export */ Va: _emscripten_glUniform2f,
  /** @export */ Ua: _emscripten_glUniform2fv,
  /** @export */ Ta: _emscripten_glUniform2i,
  /** @export */ Sa: _emscripten_glUniform2iv,
  /** @export */ Ra: _emscripten_glUniform2ui,
  /** @export */ Qa: _emscripten_glUniform2uiv,
  /** @export */ Pa: _emscripten_glUniform3f,
  /** @export */ Oa: _emscripten_glUniform3fv,
  /** @export */ Na: _emscripten_glUniform3i,
  /** @export */ Ma: _emscripten_glUniform3iv,
  /** @export */ La: _emscripten_glUniform3ui,
  /** @export */ Ka: _emscripten_glUniform3uiv,
  /** @export */ Ja: _emscripten_glUniform4f,
  /** @export */ Ia: _emscripten_glUniform4fv,
  /** @export */ Ha: _emscripten_glUniform4i,
  /** @export */ Ga: _emscripten_glUniform4iv,
  /** @export */ Fa: _emscripten_glUniform4ui,
  /** @export */ Ea: _emscripten_glUniform4uiv,
  /** @export */ Da: _emscripten_glUniformBlockBinding,
  /** @export */ Ca: _emscripten_glUniformMatrix2fv,
  /** @export */ Ba: _emscripten_glUniformMatrix2x3fv,
  /** @export */ Aa: _emscripten_glUniformMatrix2x4fv,
  /** @export */ za: _emscripten_glUniformMatrix3fv,
  /** @export */ ya: _emscripten_glUniformMatrix3x2fv,
  /** @export */ xa: _emscripten_glUniformMatrix3x4fv,
  /** @export */ wa: _emscripten_glUniformMatrix4fv,
  /** @export */ va: _emscripten_glUniformMatrix4x2fv,
  /** @export */ ua: _emscripten_glUniformMatrix4x3fv,
  /** @export */ ta: _emscripten_glUseProgram,
  /** @export */ sa: _emscripten_glValidateProgram,
  /** @export */ ra: _emscripten_glVertexAttrib1f,
  /** @export */ qa: _emscripten_glVertexAttrib1fv,
  /** @export */ pa: _emscripten_glVertexAttrib2f,
  /** @export */ oa: _emscripten_glVertexAttrib2fv,
  /** @export */ na: _emscripten_glVertexAttrib3f,
  /** @export */ ma: _emscripten_glVertexAttrib3fv,
  /** @export */ la: _emscripten_glVertexAttrib4f,
  /** @export */ ka: _emscripten_glVertexAttrib4fv,
  /** @export */ ja: _emscripten_glVertexAttribDivisor,
  /** @export */ ia: _emscripten_glVertexAttribDivisorANGLE,
  /** @export */ ha: _emscripten_glVertexAttribDivisorARB,
  /** @export */ ga: _emscripten_glVertexAttribDivisorEXT,
  /** @export */ fa: _emscripten_glVertexAttribDivisorNV,
  /** @export */ ea: _emscripten_glVertexAttribI4i,
  /** @export */ da: _emscripten_glVertexAttribI4iv,
  /** @export */ ca: _emscripten_glVertexAttribI4ui,
  /** @export */ ba: _emscripten_glVertexAttribI4uiv,
  /** @export */ aa: _emscripten_glVertexAttribIPointer,
  /** @export */ $: _emscripten_glVertexAttribPointer,
  /** @export */ _: _emscripten_glViewport,
  /** @export */ M: _emscripten_glWaitSync,
  /** @export */ Z: _emscripten_pc_get_function,
  /** @export */ Y: _emscripten_resize_heap,
  /** @export */ C: _emscripten_stack_snapshot,
  /** @export */ X: _emscripten_stack_unwind_buffer,
  /** @export */ W: _emscripten_webgl_create_context,
  /** @export */ V: _emscripten_webgl_make_context_current,
  /** @export */ Cf: _environ_get,
  /** @export */ Bf: _environ_sizes_get,
  /** @export */ L: _fd_close,
  /** @export */ K: _fd_read,
  /** @export */ Q: _fd_seek,
  /** @export */ J: _fd_write,
  ...
  /** @export */ Af: _proc_exit,
  /** @export */ zf: _random_get
};
